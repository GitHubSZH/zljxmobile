...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "1o6DwxHQ3q6Fbvliyht10siVEC0flBO8FO0fYRVb";
    private static final String SECRET_KEY = "YiIVmBo5eYJ3x7bmezgVkYjEjpmFik8eqMzEzjA9";

    // 要上传的空间
    private static final String bucketname = "zljx_image";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "image.zljx1027.cn";
